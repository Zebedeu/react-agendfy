  ...
  /*   useEffect(() => {
    ...
    */
    ...
    const handleEventResizeInternal = useCallback(
      ...
      const { filterPlugins, searchPlugins, dataSourcePlugins, customViewPlugins, eventRenderingPlugins } =
  ...
  const stableLocaleConfig = useMemo(() => ({
      ...defaultConfig,
      ...config,
      ...getLocale((config && config.lang) || defaultConfig.lang),
    }), [config]);  
